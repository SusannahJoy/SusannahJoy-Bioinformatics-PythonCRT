'''
Design a backend system to manage multiplayer game tournaments. Players register play matches,
and earn points. The system should rank them, handle tie breakers, and simulate knockout rounds.
Features:
---------
...
Sorthing Algorithms(Leaderboard)
